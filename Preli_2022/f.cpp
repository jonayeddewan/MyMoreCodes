...
void solve()
{
    ...
    int Apos=0,Aneg=0, Opos=0,Oneg=0,Bpos=0,Bneg=0,ABpos=0,ABneg=0;
    ...
    else if(s1[56]=='A' && s1[57]=='-')
    Aneg++;
    else if(s1[56]=='A' && s1[57]=='B' && s1[58]=='+')
    ABpos++;
    else if(s1[56]=='A' && s1[57]=='B' && s1[58]=='-')
    ABneg++;
    else if(s1[56]=='B' && s1[57]=='+')
    Bpos++;
    else if(s1[56]=='B' && s1[57]=='-')
    Bneg++;
    else if(s1[56]=='O' && s1[57]=='+')
    Opos++;
    else if(s1[56]=='O' && s1[57]=='-')
    Oneg++;
